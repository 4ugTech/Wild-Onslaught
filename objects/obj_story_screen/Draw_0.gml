...
draw_text(text_x, text_y + line_height*6, "Armed with only her trusted blade, Lucian must push back these botanical menaces.");
...
draw_text(text_x, text_y + line_height*13, "Beware! Rumors tell of an evil being that emerges after some time");
